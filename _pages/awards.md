...
<div class="awards">
  ...
  <div class="award-group">
    ...
    <ul class="award-list">
      <li class="award-item">
        <div class="award-main">
          <span class="award-title">ISS F2 Scholarship — Full Tuition</span>
        </div>
        <div class="award-sub">
  ...
  <div class="award-group">
    ...
    <ul class="award-list">
      <li class="award-item">
        <div class="award-main">
          <span class="award-title">Graduate Research Assistant Scholarship</span>
        </div>
        <div class="award-sub">
      ...
      <li class="award-item">
        <div class="award-main">
          <span class="award-title">ISS-V (International Students Scholarship — Volunteer-based)</span>
        </div>
        <div class="award-sub">
  ...
  <div class="award-group">
    ...
    <ul class="award-list">
      <li class="award-item">
        <div class="award-main">
          <span class="award-title">Korean Language Excellence Scholarship for International Students (HH1)</span>
        </div>
        <div class="award-sub">
